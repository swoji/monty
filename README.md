...
## Monty Interpreter
Welcome to the Monty Bytecode Interpreter, which is built in the C language. It reads Monty bytecode files of any extension (preferably `.m`), and interprets the opcodes contained.
...
```
$ git clone https://github.com/swoji/monty.git
```
